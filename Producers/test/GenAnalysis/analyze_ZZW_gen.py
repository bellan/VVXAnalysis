...
##     process.TFileService.fileName = "4ljj_QED_ZZZ.root"
    ...
    process.TFileService.fileName = "W+ZZ_3_sign.root"
elif (sample=="W-ZZ") :
...
process.analysis = cms.Path(~process.genCategory*process.printTree*process.myAnalyzer)
