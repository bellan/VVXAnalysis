...
TreePlanter::TreePlanter(const edm::ParameterSet &config)
  ...
  , thesingleRPProtonToken  (consumes<std::vector<reco::ForwardProton>>      (config.getParameter<edm::InputTag>("singleRPprotons")))
  , themultiRPProtonToken  (consumes<std::vector<reco::ForwardProton>>      (config.getParameter<edm::InputTag>("multiRPprotons")))  
