...
branchsel_in =['keep Photon*']
branchsel_out=['keep Photon*','keep regionWord*']

setConf("branchsel_in" , branchsel_in , append=True) 
setConf("branchsel_out", branchsel_out, append=True) 
