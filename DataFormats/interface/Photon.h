...
namespace phys {
  ...
  private:
		...
		float energyScaleUp_; // energy with the ecal energy scale shifted 1 sigma up (adding gain/stat/syst in quadrature) // float energyScaleDown_;	energy with the ecal energy scale shifted 1 sigma down (adding gain/stat/syst in quadrature) // float energyScaleStatUp_;	energy with the ecal energy scale shifted 1 sigma(stat) up
