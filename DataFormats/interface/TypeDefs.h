...
namespace phys{
  ...
  typedef phys::DiBoson<phys::Particle, phys::Particle> DiBosonParticle; //VVtype
  ...
  typedef std::pair<phys::Boson<phys::Particle>, phys::Particle> pairBosonParticle; //Zltype
}
