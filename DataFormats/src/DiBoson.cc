...
template<> phys::DiBoson<phys::Lepton  , phys::Electron >::~DiBoson(){}
template<> phys::DiBoson<phys::Lepton  , phys::Jet      >::~DiBoson(){}
template<> phys::DiBoson<phys::Lepton  , phys::Photon   >::~DiBoson(){}
template<> phys::DiBoson<phys::Electron, phys::Lepton   >::~DiBoson(){}
template<> phys::DiBoson<phys::Electron, phys::Electron >::~DiBoson(){}
template<> phys::DiBoson<phys::Electron, phys::Jet      >::~DiBoson(){}
template<> phys::DiBoson<phys::Electron, phys::Photon   >::~DiBoson(){}
template<> phys::DiBoson<phys::Jet     , phys::Lepton   >::~DiBoson(){}
template<> phys::DiBoson<phys::Jet     , phys::Electron >::~DiBoson(){}
...
template<> phys::DiBoson<phys::Photon  , phys::Electron >::~DiBoson(){}
