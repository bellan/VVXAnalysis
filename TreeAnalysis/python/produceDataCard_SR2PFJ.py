...
__builtin_config__ = {
    ...
    'regions': {
        'SR2PFJ': {
            ...
            'observable': {'name':'ParticleNetScore', 'observation':-1}  # Combine's name for "observable"
        }
    },
    ...
    'systematics':{
        'shape': [],
        'correlated'  : ['L1Prefiring', 'PDFVar', 'QCDscale', 'alphas'],
        'uncorrelated': [],
...
def get_sample_group_QCDscale(sample):
    if  (sample.startswith(('ZZGTo4LG','WZGTo3LNuG','ZZGTo2L2jG','WZGTo2L2jG', 'VZG' ))):
        return 'VVgamma'
