...
if typeofsample[0:8] == 'DoubleMu' or typeofsample[0:9] == 'DoubleEle' or typeofsample[0:4] == 'MuEG' or typeofsample[0:6] == 'Single' or typeofsample[0:4] == 'test' or  typeofsample[0:6] == 'MuonEG' or  typeofsample[0:6] == 'EGamma' or  typeofsample[0:8] == 'DoubleEG' or typeofsample[0:4] == str(year) or typeofsample=='data':
    luminosity = -1
    isData = True
