...
def skipsample(filename):
    ...
    if filename == '2018_data.root': return True
...
def main():
    ...
    parser.add_argument('-A', '--analyzer' , default='VZGAnalyzer', help='Name of the analyzer, used to compose the path of the input files')
    ...
    for region in args.regions:
        ...
        for predType in ('fullMC', 'lepCR', 'phoCR'):
            try:
                temp = {sample['name']: sample for sample in getVZGSamplesByRegion(region, args.mcset, predType)}
