...
def SetAcceptance(inputdir,SampleType, SavePlot,SistErr):
        ...
        if SavePlot:
            ...
            if SistErr=="0": 
                if "fr" in Set:  
                    ...
                    c2.SaveAs("~/www/VBS/Acceptance/Acceptance_for_"+Fin+"_"+SampleType+".png")
                else:
                    c2.SaveAs("Plot/Acceptance/Acceptance_for_"+Fin+"_"+SampleType+".png")
                    c2.SaveAs("~/www/VBS/Acceptance/Acceptance_for_"+Fin+"_"+SampleType+"_fr.png")
    ...
    if SistErr=="0":
        if "fr" in Set: 
            ...
            c1.SaveAs("~/www/VBS/Acceptance/DiffAcceptance_"+SampleType+"_"+Set+"_fr.png") 
        else:        
            c1.SaveAs("./Plot/Acceptance/DiffAcceptance_"+SampleType+"_"+Set+".png") 
            c1.SaveAs("~/www/VBS/Acceptance/DiffAcceptance_"+SampleType+"_"+Set+".png") 
        
        
        #c1.SaveAs("./Plot/Acceptance/DiffAcceptance_"+SampleType+"_"+Set+"_fr.pdf")   
        #c1.SaveAs("./Plot/Acceptance/DiffAcceptance_"+SampleType+"_"+Set+"_fr.root") 
        #c1.SaveAs("./Plot/Acceptance/DiffAcceptance_"+SampleType+"_"+Set+"_fr.eps") 
