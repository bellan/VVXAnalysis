...
class TString;
struct FeatList{
  double f_weight, f_posWeight, f_weightIfCR2P1F, f_posWeightIfCR2P1F, f_J0qvgSF, f_J1qvgSF, f_ZXrw, f_mll, f_ptGamma, f_ptl1, f_ptl2, f_ptJ0, f_ptJ1, f_etaL0, f_etaL1, f_etaJ0, f_etaJ1, f_dPhiL0G, f_dPhiL1G, f_dPhiLL, f_dPhiJ0G, f_dPhiJ1G, f_dPhiJJ, f_dPhiL0J0, f_dPhiL1J0, f_dPhiL0J1, f_dPhiL1J1, f_recoVMass, f_deltaR_L0Gamma, f_deltaR_L1Gamma, f_deltaR_J0Gamma, f_deltaR_J1Gamma, f_deltaR_LL, f_deltaR_JJ, f_FWMT0, f_FWMT1, f_FWMT2, f_FWMT3, f_FWMT4, f_mllPh, f_FWMT5, f_FWMT6,
  ...
  bool f_J0Loose, f_J1Loose, f_isData;
};
