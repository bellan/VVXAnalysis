...
{   
  ...
  matrix_jesf->Build_SF(var,"01","4e","SFErrMinus",madgraph);
  matrix_jesf->Build_SF(var,"01","4e","SFErrPlus",madgraph);
  matrix_jesf->Build_SF(var,"01","4m","SFErrSqMinus",madgraph);
  matrix_jesf->Build_SF(var,"01","4m","SFErrSqPlus",madgraph);
  matrix_jesf->Build_SF(var,"01","4m","SFErrMinus",madgraph);
  matrix_jesf->Build_SF(var,"01","4m","SFErrPlus",madgraph);
  matrix_jesf->Build_SF(var,"01","2e2m","SFErrSqMinus",madgraph);
  matrix_jesf->Build_SF(var,"01","2e2m","SFErrSqPlus",madgraph);
  matrix_jesf->Build_SF(var,"01","2e2m","SFErrMinus",madgraph);
  matrix_jesf->Build_SF(var,"01","2e2m","SFErrPlus",madgraph); 
...
{   
  ...
  GenerateGenMCUpDown_Var("CentralJets"); 
  GenerateGenMCUpDown_Var("CentralMjj"); 
  GenerateGenMCUpDown_Var("CentralDeta");
...
{   
  ...
  GenerateGenMGatNLOUpDownDistributions("CentralJets",0); 
  GenerateGenMGatNLOUpDownDistributions("CentralMjj",0); 
  GenerateGenMGatNLOUpDownDistributions("CentralDeta",0);
  ...
  GenerateGenMGatNLOUpDownDistributions("CentralJets",1); 
  GenerateGenMGatNLOUpDownDistributions("CentralMjj",1); 
  GenerateGenMGatNLOUpDownDistributions("CentralDeta",1);
