...
void Unfold_data(string var = "Mass", string fs = "4e", bool mad =1,bool tightregion = 0, string date = "test"){
  ...
  else if(var == "CentralJets")  XaxisTitle = "N Central Jets (" + finalstate + " final state)";
  else if(var == "Mjj" ||var == "CentralMjj")  XaxisTitle = "m_{jj} (" + finalstate + " final state) [GeV]";
  else if(var == "Deta"||var == "CentralDeta")  XaxisTitle = "#Delta#eta_{jj} (" + finalstate + " final state)";
  ...
  else if(var == "Jets"||var == "CentralJets")  max =  h_unfolded->GetBinContent(1)+h_unfolded->GetBinContent(1)*0.15+h_unfolded->GetBinError(1); 
  else if(var == "Mjj"|| var == "CentralMjj") max =  h_true->GetBinContent(1)+h_true->GetBinContent(1)*0.20+h_unfolded->GetBinError(1); 
  else if(var == "Deta"|| var == "CentralDeta" ) max =  h_true->GetBinContent(1)+h_true->GetBinContent(1)*0.15+h_unfolded->GetBinError(1); 
  ...
  else if(var == "Jets" ||var == "CentralJets") line =  new TLine(0,1,4,1);
  else if(var == "Mjj" || var == "CentralMjj") line =  new TLine(0,1,800,1);
  else if(var == "Deta"  || var == "CentralDeta") line =  new TLine(0,1,4.7,1);
...
void DoUnfoldedDataOverGenMCRatio(string var = "Mass", string fs = "4e", bool mad =1,bool tightregion = 0){
 ...
 else if(var =="Mjj" || var =="CentralMjj"){
    b=3;
    XaxisTitle = "m_{jj} ("+finalstate+"-final state)";
  }
 else if(var =="Deta"  || var =="CentralDeta"){
    b=3;
...
void  DoAllSystematics(string var = "Mass", bool mad =1, bool tightregion =0){
  ...
  if(var == "Jets"||var == "Mjj"||var == "Deta" || var == "CentralJets"||var == "CentralMjj"||var == "CentralDeta"||var == "PtJet1"||var == "PtJet2"||var == "EtaJet1"||var == "EtaJet2"){
...
void PlotResults(string var = "Jets", string fs = "4e", string syst = "MCgen", bool mad =1,bool tightregion =0, string date = "test"){
  ...
  if(syst == "MCgen" || syst == "UnfDataOverGenMC"){
    ...
    for(int i = 1; i<9; i++){
      ...
      float vec[] ={h_unfolded_p->GetBinContent(i),h_unfolded_m->GetBinContent(i),h_unfolded->GetBinContent(i)};
      min =vec[0];
      max =0;
 ...
 if(var == "Mass"){
  ...
  if(var =="Mjj"||var =="CentralMjj") h_max->GetYaxis()->SetTitleOffset(1.8);
  else  h_max->GetYaxis()->SetTitleOffset(1.4);
  h_max->GetXaxis()->SetTitleOffset(1.2);
  if(var == "CentralMjj" && fs == "2e2m") h_max->SetMaximum(0.1);  
...
void AllSystematicPlotsForAllVariables(bool mad =1,bool tightregion =0,string date = "test"){
  ...
  AllPlots("CentralJets",mad, tightregion, date);
  AllPlots("Mjj",mad, tightregion, date);
  AllPlots("CentralMjj",mad, tightregion, date);
  AllPlots("Deta",mad, tightregion, date);
  AllPlots("CentralDeta",mad, tightregion, date);
...
void AllYouNeed(bool mad =1, bool tightregion = 0){
  ...
  Unfold_data_All("CentralJets",mad,tightregion);
  DoAllRatios("CentralJets",mad,tightregion);
  DoAllSystematics("CentralJets",mad,tightregion);
  Unfold_data_All("CentralMjj",mad,tightregion);
  DoAllRatios("CentralMjj",mad,tightregion);
  DoAllSystematics("CentralMjj",mad,tightregion);
  Unfold_data_All("CentralDeta",mad,tightregion);
  DoAllRatios("CentralDeta",mad,tightregion);
  DoAllSystematics("CentralDeta",mad,tightregion);
}
...
void PlotUnfoldData4L(string var = "Jets", bool mad =1,bool tightregion =0, string date = "test"){
  ...
  else if(var == "Mjj"|| var == "CentralMjj") max =  h_gen4e->GetBinContent(1)+h_gen4e->GetBinContent(1)*0.20+h_unfdata4e->GetBinError(1); 
  else if(var == "Deta"|| var == "CentralDeta" ) max =  h_gen4e->GetBinContent(1)+h_gen4e->GetBinContent(1)*0.15+h_unfdata4e->GetBinError(1); 
...
void AllPlot4L(bool mad =1, bool tightregion =0,string date = "test")
{
  ...
  PlotUnfoldData4L("CentralJets",mad, tightregion, date);
  PlotUnfoldData4L("Mjj",mad, tightregion, date);
  PlotUnfoldData4L("CentralMjj",mad, tightregion, date);
  PlotUnfoldData4L("Deta",mad, tightregion, date);
  PlotUnfoldData4L("CentralDeta",mad, tightregion, date);
...
void PlotUnfoldData(string var = "Jets", string fs = "4e", bool mad =1,bool tightregion =0, string date = "test"){
  ...
  else if(var == "Jets"||var == "CentralJets")  max =  h_unfdata->GetBinContent(1)+h_unfdata->GetBinContent(1)*0.50+h_unfdata->GetBinError(1); 
  else if(var == "Mjj"|| var == "CentralMjj") max =  h_gen->GetBinContent(1)+h_gen->GetBinContent(1)*0.50+h_unfdata->GetBinError(1); 
  else if(var == "Deta"|| var == "CentralDeta" ) max =  h_gen->GetBinContent(1)+h_gen->GetBinContent(1)*0.50+h_unfdata->GetBinError(1); 
...
void AllPlotBinWidth(bool mad =1, bool tightregion =0,string date = "test")
{
  ...
  PlotUnfoldData("CentralJets","4e",mad, tightregion, date);
  PlotUnfoldData("Mjj","4e",mad, tightregion, date);
  PlotUnfoldData("CentralMjj","4e",mad, tightregion, date);
  PlotUnfoldData("Deta","4e",mad, tightregion, date);
  PlotUnfoldData("CentralDeta","4e",mad, tightregion, date);
  ...
  PlotUnfoldData("CentralJets","4m",mad, tightregion, date);
  PlotUnfoldData("Mjj","4m",mad, tightregion, date);
  PlotUnfoldData("CentralMjj","4m",mad, tightregion, date);
  PlotUnfoldData("Deta","4m",mad, tightregion, date);
  PlotUnfoldData("CentralDeta","4m",mad, tightregion, date);
  ...
  PlotUnfoldData("CentralJets","2e2m",mad, tightregion, date);
  PlotUnfoldData("Mjj","2e2m",mad, tightregion, date);
  PlotUnfoldData("CentralMjj","2e2m",mad, tightregion, date);
  PlotUnfoldData("Deta","2e2m",mad, tightregion, date);
  PlotUnfoldData("CentralDeta","2e2m",mad, tightregion, date);
...
void FakeUnfold_data(string var = "Mass", string fs = "4e", bool mad =1,bool tightregion = 0, string date = "test", bool bayes = 1, int kreg = 2){
  ...
  else if(var == "CentralJets")  XaxisTitle = "N Central Jets (|#eta^{jet}|<2.4)";
...
void PlotResults_4l(string var = "Jets", string syst = "MCgen", bool mad =1,bool tightregion =0, string date = "test"){
  ...
  if(syst == "MCgen" || syst == "UnfDataOverGenMC"){
    ...
    for(int i = 1; i<9; i++){
      ...
      float vec_4e[] ={h_unfolded_4e_p->GetBinContent(i),h_unfolded_4e_m->GetBinContent(i),h_unfolded_4e->GetBinContent(i)};
      float vec_4m[] ={h_unfolded_4m_p->GetBinContent(i),h_unfolded_4m_m->GetBinContent(i),h_unfolded_4m->GetBinContent(i)};
      float vec_2e2m[] ={h_unfolded_2e2m_p->GetBinContent(i),h_unfolded_2e2m_m->GetBinContent(i),h_unfolded_2e2m->GetBinContent(i)};
      float max_4e = 0;
