...
{  
  ...
  if(weight==0){
    ggZZTo2e2mu_r = new TFile("../../results/ZZRecoAnalyzer_SR/ggTo2e2mu_SMHContinInterf-MCFM67_H125.6.root");
    ggZZTo4e_r = new TFile("../../results/ZZRecoAnalyzer_SR/ggTo4e_SMHContinInterf-MCFM67_H125.6.root");
    ggZZTo4mu_r = new TFile("../../results/ZZRecoAnalyzer_SR/ggTo4mu_SMHContinInterf-MCFM67_H125.6.root");
    ZZJetsTo4l_r = new TFile("../../results/ZZRecoAnalyzer_SR/ZZJetsTo4L.root");
    ZZTo2e2muJJ_r = new TFile("../../results/ZZRecoAnalyzer_SR/ZZTo2e2muJJ_SMHContinInterf_H125.6.root");
    ZZTo4eJJ_r = new TFile("../../results/ZZRecoAnalyzer_SR/ZZTo4eJJ_SMHContinInterf_H125.6.root");
    ZZTo4muJJ_r = new TFile("../../results/ZZRecoAnalyzer_SR/ZZTo4muJJ_SMHContinInterf_H125.6.root"); 
    ZZTo4mu_r = new TFile("../../results/ZZRecoAnalyzer_SR/ZZTo4mu.root");
    ZZTo4e_r = new TFile("../../results/ZZRecoAnalyzer_SR/ZZTo4e.root");
    ZZTo2e2mu_r = new TFile("../../results/ZZRecoAnalyzer_SR/ZZTo2e2mu.root");
    
    //Truth samples (signal definition distributions) 
    ggZZTo2e2mu_g = new TFile("../../results/ZZMCAnalyzer_MC/ggTo2e2mu_SMHContinInterf-MCFM67_H125.6.root");
    ggZZTo4e_g = new TFile("../../results/ZZMCAnalyzer_MC/ggTo4e_SMHContinInterf-MCFM67_H125.6.root");
    ggZZTo4mu_g = new TFile("../../results/ZZMCAnalyzer_MC/ggTo4mu_SMHContinInterf-MCFM67_H125.6.root");
    ZZJetsTo4l_g = new TFile("../../results/ZZMCAnalyzer_MC/ZZJetsTo4L.root");
    ZZTo2e2muJJ_g = new TFile("../../results/ZZMCAnalyzer_MC/ZZTo2e2muJJ_SMHContinInterf_H125.6.root");
    ZZTo4eJJ_g = new TFile("../../results/ZZMCAnalyzer_MC/ZZTo4eJJ_SMHContinInterf_H125.6.root");
    ZZTo4muJJ_g = new TFile("../../results/ZZMCAnalyzer_MC/ZZTo4muJJ_SMHContinInterf_H125.6.root");
    ZZTo4mu_g = new TFile("../../results/ZZMCAnalyzer_MC/ZZTo4mu.root");
    ZZTo4e_g = new TFile("../../results/ZZMCAnalyzer_MC/ZZTo4e.root");
    ZZTo2e2mu_g = new TFile("../../results/ZZMCAnalyzer_MC/ZZTo2e2mu.root");
    
    //Files for Powheg and MGatNLO theoretical uncertainties
    ...
    //rescue file
    rescue = new TFile("../../results/ZZRecoAnalyzer_SR/tt.root");
    ...
    ggZZTo2e2mu_r = new TFile("../../results/ZZRecoWAnalyzer_SR/ggTo2e2mu_SMHContinInterf-MCFM67_H125.6.root");
    ggZZTo4e_r = new TFile("../../results/ZZRecoWAnalyzer_SR/ggTo4e_SMHContinInterf-MCFM67_H125.6.root");
    ggZZTo4mu_r = new TFile("../../results/ZZRecoWAnalyzer_SR/ggTo4mu_SMHContinInterf-MCFM67_H125.6.root");
    ZZJetsTo4l_r = new TFile("../../results/ZZRecoWAnalyzer_SR/ZZJetsTo4L.root");
    ZZTo2e2muJJ_r = new TFile("../../results/ZZRecoWAnalyzer_SR/ZZTo2e2muJJ_SMHContinInterf_H125.6.root");
    ZZTo4eJJ_r = new TFile("../../results/ZZRecoWAnalyzer_SR/ZZTo4eJJ_SMHContinInterf_H125.6.root");
    ZZTo4muJJ_r = new TFile("../../results/ZZRecoWAnalyzer_SR/ZZTo4muJJ_SMHContinInterf_H125.6.root");
    ZZTo4mu_r = new TFile("../../results/ZZRecoWAnalyzer_SR/ZZTo4mu.root");
    ZZTo4e_r = new TFile("../../results/ZZRecoWAnalyzer_SR/ZZTo4e.root");
    ZZTo2e2mu_r = new TFile("../../results/ZZRecoWAnalyzer_SR/ZZTo2e2mu.root");
    
    //Truth samples (signal definition distributions) 
    ggZZTo2e2mu_g = new TFile("../../results/ZZMCWAnalyzer_MC/ggTo2e2mu_SMHContinInterf-MCFM67_H125.6.root");
    ggZZTo4e_g = new TFile("../../results/ZZMCWAnalyzer_MC/ggTo4e_SMHContinInterf-MCFM67_H125.6.root");
    ggZZTo4mu_g = new TFile("../../results/ZZMCWAnalyzer_MC/ggTo4mu_SMHContinInterf-MCFM67_H125.6.root");
    ZZJetsTo4l_g = new TFile("../../results/ZZMCWAnalyzer_MC/ZZJetsTo4L.root");
    ZZTo2e2muJJ_g = new TFile("../../results/ZZMCWAnalyzer_MC/ZZTo2e2muJJ_SMHContinInterf_H125.6.root");
    ZZTo4eJJ_g = new TFile("../../results/ZZMCWAnalyzer_MC/ZZTo4eJJ_SMHContinInterf_H125.6.root");
    ZZTo4muJJ_g = new TFile("../../results/ZZMCWAnalyzer_MC/ZZTo4muJJ_SMHContinInterf_H125.6.root");
    ZZTo4mu_g = new TFile("../../results/ZZMCWAnalyzer_MC/ZZTo4mu.root");
    ZZTo4e_g = new TFile("../../results/ZZMCWAnalyzer_MC/ZZTo4e.root");
    ZZTo2e2mu_g = new TFile("../../results/ZZMCWAnalyzer_MC/ZZTo2e2mu.root");   
   
    //rescue file
    rescue = new TFile("../../results/ZZRecoWAnalyzer_SR/tt.root");
...
{ 
  ...
  else if(var == "Jets" ||var == "CentralJets"){
    variable = var + "_JERCentralSmear";
    b=6;
  }
  else if(var == "Mjj" ||var == "CentralMjj" || var == "Deta" || var == "CentralDeta"){
    variable = var+"_JERCentralSmear";
    b=3;
  }
  ...
  //cout << finalstate << " qq4e " <<  h_qq4e->Integral() <<  " qq4m " <<  h_qq4mu->Integral() << " qq2e2m " <<  h_qq2e2mu->Integral() << endl;
  //cout << finalstate << " gg4e " <<  h_gg4e->Integral() <<  " gg4m " <<  h_gg4mu->Integral() << " gg2e2m " <<  h_gg2e2mu->Integral() << endl;
  
 
 TH2 * h_Resmat_qq4mu_cl = (TH2*)h_Resmat_qq4mu->Clone("h_Resmat_qq4mu");
 TH1 * h_qq4mu_cl = (TH1*) h_qq4mu->Clone("h_4l");
 TH1 * h_qq4mu_gen_cl = (TH1*) h_qq4mu_gen->Clone("h_4l");
 TH2 * h_Resmat_gg4mu_cl = (TH2*)h_Resmat_gg4mu->Clone("h_Resmat_qq4mu");
 TH1 * h_gg4mu_cl = (TH1*) h_gg4mu->Clone("h_4l");
 TH1 * h_gg4mu_gen_cl = (TH1*) h_gg4mu_gen->Clone("h_4l");
 TH2 * h_Resmat_4muJJ_cl = (TH2*)h_Resmat_4muJJ->Clone("h_Resmat_qq4mu");
 ...
 TH1 * h_4muJJ_gen_cl = (TH1*) h_4muJJ_gen->Clone("h_4l");
  ...
  h_qq4mu_cl->Add(h_qq4e); 
  h_qq4mu_cl->Add(h_qq2e2mu); 
  h_qq4mu_gen_cl->Add(h_qq4e_gen);
  h_qq4mu_gen_cl->Add(h_qq2e2mu_gen);
  h_Resmat_qq4mu_cl->Add(h_Resmat_qq4e, 1); 
  h_Resmat_qq4mu_cl->Add(h_Resmat_qq2e2mu, 1); 

  

  //cout << finalstate << " 4l " <<  h_qq4mu_cl->Integral() << " gg " << h_gg4mu_cl->Integral() << " qqJJ " << h_4muJJ_cl->Integral() << endl;
  if(mad ==1){
    h_Resmat_4lTot = (TH2*)h_Resmat_4l->Clone("h_Resmat_4l");
    h_4lTot = (TH1*) h_4l->Clone("h_4l");
    h_4lTot_gen = (TH1*) h_4l_gen->Clone("h_4l");
  }
  else{
    h_Resmat_4lTot = (TH2*)h_Resmat_qq4mu_cl->Clone("h_Resmat_qq4mu");
    h_4lTot = (TH1*) h_qq4mu_cl->Clone("h_qq4mu");
    h_4lTot_gen = (TH1*) h_qq4mu_gen_cl->Clone("h_qq4mu");
  }
...
void ResponseMatrix::Build_SF(string var, string dataset, string finalstate, string unc, bool mad)
{
  ...
  if(var == "Jets" ||var == "CentralJets")b =6;
  ...
  else observable = var + "_JERCentralSmear"; 

  safeMatrixName = "ResMat_ZZTo2e2m_" + observable + "_01";
  safeHistoName = "ZZTo2e2m_" + observable + "_01";
  matrixName = "ResMat_ZZTo" + finalstate + "_"+var+unc+"_"+ dataset + tightfr;
  histoName_reco = "ZZTo" + finalstate + "_"+var+unc +"_"+ dataset;
  ...
  if(mad ==1){
    ...
    h_Resmat_4lTot = (TH2*)h_Resmat_qq4mu->Clone("h_Resmat_qq4mu");
    h_4lTot = (TH1*) h_qq4mu->Clone("h_qq4mu");
    h_4lTot_gen = (TH1*) h_qq4mu_gen->Clone("h_qq4mu");
  }
...
void ResponseMatrix::Build_JE(string var, string dataset, string finalstate, string unc, bool mad)
{
  ...
  safeMatrixName = "ResMat_ZZTo2e2m_" + var +"_JERCentralSmear_01";
  safeHistoName = "ZZTo2e2m_" + var +"_JERCentralSmear_01"; 
...
void ResponseMatrix::GenMCSystDistributions(string var, string dataset, string finalstate, bool mad)
{
  ...
  h_qq4mu_up_gen = (TH1*) h_qq4mu_gen->Clone("h_qq4mu_gen"); //
  h_qq4e_up_gen =  (TH1*) h_qq4e_gen->Clone("h_qq4e_gen"); 
  h_qq2e2mu_up_gen = (TH1*) h_qq2e2mu_gen->Clone("qq2e2mu_gen");
  h_qq4mu_down_gen = (TH1*) h_qq4mu_gen->Clone("qq4mu_gen"); //
  h_qq4e_down_gen = (TH1*) h_qq4e_gen->Clone("h_qq4e_gen"); 
  h_qq2e2mu_down_gen = (TH1*) h_qq2e2mu_gen->Clone("qq2e2mu_gen");
    
  if(h_qq4mu_up_gen == NULL) h_qq4mu_up_gen = (TH2*) h_safe->Clone("h_safe");//
  if(h_qq4e_up_gen == NULL) h_qq4e_up_gen = (TH2*) h_safe->Clone("h_safe");//
  if(h_qq2e2mu_up_gen == NULL) h_qq2e2mu_up_gen = (TH2*) h_safe->Clone("h_safe");//
  if(h_qq4mu_down_gen == NULL) h_qq4mu_down_gen = (TH2*) h_safe->Clone("h_safe");//
  if(h_qq4e_down_gen == NULL) h_qq4e_down_gen = (TH2*) h_safe->Clone("h_safe");//
  if(h_qq2e2mu_down_gen == NULL) h_qq2e2mu_down_gen = (TH2*) h_safe->Clone("h_safe");//
 
  h_qq_up_gen = (TH1*) ZZMCsystPow_g->Get(histoMCup.c_str());
  h_qq_down_gen = (TH1*) ZZMCsystPow_g->Get(histoMCdown.c_str());
  
  int nbins = h_qq4mu_gen->GetNbinsX();
  float up_cont = 0;
  float down_cont = 0;
  float def_cont_4e = 0;
  float def_cont_4mu = 0;
  float def_cont_2e2mu = 0;
  ...
  for(int i=1; i <= nbins; i++){
    ...
    up_cont = h_qq_up_gen->GetBinContent(i);  
    down_cont = h_qq_down_gen->GetBinContent(i);  
    def_cont_4e = h_qq4e_gen->GetBinContent(i);
    def_cont_4mu =h_qq4mu_gen->GetBinContent(i);
    def_cont_2e2mu = h_qq2e2mu_gen->GetBinContent(i);
    
    h_qq4e_up_gen->SetBinContent(i,def_cont_4e*up_cont); 
    h_qq4mu_up_gen->SetBinContent(i,def_cont_4mu*up_cont); 
    h_qq2e2mu_up_gen->SetBinContent(i,def_cont_2e2mu*up_cont);
    h_qq4e_down_gen->SetBinContent(i,def_cont_4e*down_cont);
    h_qq4mu_down_gen->SetBinContent(i,def_cont_4mu*down_cont); 
    h_qq2e2mu_down_gen->SetBinContent(i,def_cont_2e2mu*down_cont);
  ...
  h_qq4mu_up_gen->Add(h_qq4e_up_gen);
  h_qq4mu_up_gen->Add(h_qq2e2mu_up_gen);
  h_qq4mu_down_gen->Add(h_qq4e_down_gen);
  h_qq4mu_down_gen->Add(h_qq2e2mu_down_gen);
  
  if(mad ==1){
    h_4lTot_up_gen = (TH1*) h_4l_gen->Clone("h_4l");
    h_4lTot_down_gen = (TH1*) h_4l_gen->Clone("h_4l");
  }
  else{
    h_4lTot_up_gen = (TH1*) h_qq4mu_up_gen->Clone("h_qq4mu_up"); 
    h_4lTot_down_gen = (TH1*) h_qq4mu_down_gen->Clone("h_qq4mu_down");
  }
...
//Build response matrix, reco and gen distributions needed for the theoretical uncertainty on MadGraph5_aMCatNLO
void ResponseMatrix::GenMGatNLOSystDistributions(string var, string dataset, string finalstate)
{
  ...
  h_qq4mu_gen = (TH1*) ZZMCsystMGatNLO_g->Get(histoMCcentral.c_str()); 
  h_qq4mu_up_gen = (TH1*)ZZMCsystMGatNLO_g->Get(histoMCup.c_str());
  h_qq4mu_down_gen = (TH1*)ZZMCsystMGatNLO_g->Get(histoMCdown.c_str());
  ...
  TH1 *h_qq4mu_cl = (TH1*) h_qq4mu_gen->Clone("h_qq4mu_gen");
  TH1 *h_qq4mu_up_cl = (TH1*) h_qq4mu_up_gen->Clone("h_qq4mu_up_gen");
  TH1 *h_qq4mu_down_cl = (TH1*) h_qq4mu_down_gen->Clone("h_qq4mu_down_gen");
  float norm = h_4l_gen->Integral()/h_qq4mu_gen->Integral();

  h_qq4mu_cl->Scale(norm);
  h_qq4mu_up_cl->Scale(norm);
  h_qq4mu_down_cl->Scale(norm);

  cout <<"final state: "<< finalstate <<  " MGatLO = " << h_4l_gen->Integral() << " MGatNLO = " << h_qq4mu_gen->Integral() << " MGatNLO Up = " << h_qq4mu_up_gen->Integral() << " MGatNLO Down = " << h_qq4mu_down_gen->Integral() << endl;
  cout << "norm = " << norm << endl;  
  cout <<"final state: "<< finalstate <<  " MGatNLO = " << h_qq4mu_cl->Integral() << " MGatNLO Up = " << h_qq4mu_up_cl->Integral() << " MGatNLO Down = " << h_qq4mu_down_cl->Integral() << endl;
   
  cout << finalstate << " " << h_4l_gen->GetBinContent(1) << " "<< h_qq4mu_cl->GetBinContent(1) << " " <<h_gg4mu_gen->GetBinContent(1) << " " << h_4muJJ_gen->GetBinContent(1) << " " << h_qq4mu_cl->GetBinContent(1) + h_gg4mu_gen->GetBinContent(1) +h_4muJJ_gen->GetBinContent(1) <<endl;
  cout << finalstate << " " << h_4l_gen->GetBinContent(2) << " "<< h_qq4mu_cl->GetBinContent(2) << " " <<h_gg4mu_gen->GetBinContent(2) << " " << h_4muJJ_gen->GetBinContent(2) << " " << h_qq4mu_cl->GetBinContent(2) + h_gg4mu_gen->GetBinContent(2) +h_4muJJ_gen->GetBinContent(2) <<endl;
  h_4lTot_gen = (TH1*) h_qq4mu_cl->Clone("h_qq4mu_central"); 
  h_4lTot_up_gen = (TH1*) h_qq4mu_up_cl->Clone("h_qq4mu_up"); 
  h_4lTot_down_gen = (TH1*) h_qq4mu_down_cl->Clone("h_qq4mu_down");
