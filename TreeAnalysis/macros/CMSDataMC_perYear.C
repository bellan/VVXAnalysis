...
TString resDir= "resultsForAppendixPlotsFullRun2";//"resultsForNNLOshapeDisagreementFullRun2";//"resultsForNNLOshapeDisagreement";//
//TString year="2018";
...
void CMSDataMC_perYear()
{
  ...
  for(int i=0; i<1; i++){
    ...
    */
    ...
    for(int iRegion=1; iRegion<regions.size(); iRegion++){
