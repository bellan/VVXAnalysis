...
void CMSDataMCPlotter()
{
  ...
  TString path_to_rootOutput= "../results_highBDTonly/Run2/VZGAnalyzer_SR2P/";
  ...
  for(int iRegion=0; iRegion<regions.size(); iRegion++){
	...
	//	else stack->SetMaximum(aggrBin*10000);
      ...
      */
      ...
      if (isLogScale) {
	canvas->SaveAs("../DistributionPlots/Run2/LogScale/resultsForANv4plus_"+varName+"_"+regions[iRegion]+".png");
	canvas->SaveAs("../DistributionPlots/Run2/LogScale/resultsForANv4plus_"+varName+"_"+regions[iRegion]+".pdf");
      }/*
      else {
