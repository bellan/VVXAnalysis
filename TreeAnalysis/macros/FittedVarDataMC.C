...
void FittedVarDataMC()
{
  ...
  */
  ...
  TString varName="SYS_BDTScore_central";
  TString varLabel="BDT Score";
  ...
  */
  if (isLogScale){
    canvas->SaveAs(path_to_rootOutput+"LogScale/BDTScoreForFit.png");
    canvas->SaveAs(path_to_rootOutput+"LogScale/BDTScoreForFit.pdf");
  }
  else {
    canvas->SaveAs(path_to_rootOutput+"LinScale/BDTScoreForFit.png");
    canvas->SaveAs(path_to_rootOutput+"LinScale/BDTScoreForFit.pdf");
  }
