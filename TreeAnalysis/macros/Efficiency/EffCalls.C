...
void effPhotons(const char* path, const char* name){
  ...
  doEfficiency2D(fileIn, "A:u ph loose 4","A:u ph loose 5", "Fake G 5_over_4", 
                "#gamma ID_{5} / ID_{#geq4} (WP loose);p_{t} [GeV/c];|#eta|;Fake Rate");
  doEfficiency2D(fileIn, "A:u ph loose 3","A:u ph loose 5", "Fake G 5_over_3", 
                "#gamma ID_{5} / ID_{#geq3} (WP loose);p_{t} [GeV/c];|#eta|;Fake Rate");
  doEfficiency2D(fileIn, "A:u ph kinem","A:u ph loose 5","Fake G 5_over_kin", 
                "#gamma ID_{5} / kin;p_{t} [GeV/c] (WP loose);|#eta|;Fake Rate");
