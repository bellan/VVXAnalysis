...
combine $rootpostfit $fit_options -n .freeze_datadr --freezeNuisanceGroups datadr || print_error "Fit freeze_datadr"

echo "### Fitting freeze_datadr_lumi ###"
combine $rootpostfit $fit_options -n .freeze_datadr_lumi --freezeNuisanceGroups datadr,lumi || print_error "Fit freeze_datadr_lumi"

echo "### Fitting freeze_datadr_lumi_theory ###"
combine $rootpostfit $fit_options -n .freeze_datadr_lumi_theory --freezeNuisanceGroups datadr,lumi,theory || print_error "Fit freeze_datadr_lumi_theory"
